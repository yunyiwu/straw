...
Once you've installed the library with `pip install hic-straw`, you can import your code with `import hicstraw`,  or `pip install strawC-0.0.8-cp38-cp38-linux_x86_64.whl` and ` pip install hic_straw-1.3.1-cp38-cp38-linux_x86_64.whl` in this folder.
